...
All notable changes to the OPOSS Vertiv/Liebert UPS monitoring plugin will be documented in this file.
...
- **CRITICAL**: Fallback logic now correctly handles zero values
  ...
  - Fix: Changed to `if value == ""` for explicit empty string check
...
|---------|------|-------------|
| 0.0.8 | 2024-11-13 | Fixed 230V voltage thresholds, disabled by default |
| 0.0.7 | 2024-11-13 | Fixed system status string values support |
| 0.0.6 | 2024-11-13 | Critical bug fixes + major code refactor (DRY) |
| 0.0.5 | 2024-11-13 | Added ECO mode, input stats, 52+ OIDs total |
| 0.0.4 | 2024-11-13 | Fixed Liebert OID unit conversions |
| 0.0.3 | 2024-11-13 | Fixed render functions, graph unit mixing |
| 0.0.2 | 2024-11-13 | Initial release, 40+ OIDs, comprehensive monitoring |

---

## Upgrade Notes

### Upgrading to 0.0.8 from earlier versions
- **Action Required**: If you have 230V systems and configured voltage thresholds, verify they are appropriate
- Voltage thresholds are now disabled by default - configure via CheckMK rules if needed
- Recommended 230V thresholds: Upper 253V/265V, Lower 207V/195V

### Upgrading to 0.0.6 from earlier versions
- No configuration changes required
- Services will continue working with existing thresholds
- Benefits from critical bug fixes and improved code quality

### Upgrading to 0.0.4 from 0.0.2 or 0.0.3
- **Critical**: Metrics will show correct values after upgrade
...
- **GitHub Issues**: https://github.com/oposs/cmk-oposs_vertiv_ups/issues
